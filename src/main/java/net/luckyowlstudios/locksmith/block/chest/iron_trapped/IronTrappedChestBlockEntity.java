...
public class IronTrappedChestBlockEntity extends ChestBlockEntity {

    public IronTrappedChestBlockEntity(BlockPos pos, BlockState blockState) {
        super(ModBlockEntityTypes.IRON_TRAPPED_CHEST_BLOCK_ENTITY.get(), pos, blockState);
    }
